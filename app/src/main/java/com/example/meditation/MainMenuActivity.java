...
public class MainMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtHello.setText(txtHello.getText().toString() + LoginActivity.User.getNickName() + "!");
        ...
        new AdapterQuete.DownloadImageTask((ImageView) imgProfile)
                .execute(LoginActivity.User.getAvatar());
    }
   @Override
    protected void onSaveInstanceState(Bundle outState) {

        outState.putString(userKey, "fgfggf");
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        String str = savedInstanceState.getString(userKey);
